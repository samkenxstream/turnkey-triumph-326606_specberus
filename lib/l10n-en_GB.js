...
exports.messages = {
    ...
    'headers.w3c-state.bad-w3c-state':
        'Incorrect w3c status element, <code>&lt;p id="w3c-state"&gt;</code>.',
    'headers.w3c-state.no-w3c-state-link':
        'Cannot find the link of the W3C profile pointing to "https://www.w3.org/standards/types#xx".',
    ...
    'headers.details-summary.no-details':
        'Cannnot find the &lt;details&gt; element in the header of the document.',
    ...
    'headers.details-summary.no-details-dl':
        'Cannnot find the &lt;dl&gt; in headers &lt;details&gt; element of the document.',
    'headers.details-summary.no-details-summary':
        'Cannnot find the &lt;summary&gt; in headers &lt;details&gt; element of the document.',
    ...
    'sotd.deployment.not-found':
        'Cannot found the paragraph regarding deployment in the Status of This Document',
    // sotd/submission
    ...
    'sotd.stability.no-rec-review':
        'No indication that the Recommendation has received the endorsement of the W3C and its Members.',
    ...
    // sotd/status
    'sotd.status.no-mention':
        '<em>&ldquo;status of this document&rdquo;</em> does not mention that this is a ${status}.',
    // sotd/review-end
    ...
    'sotd.draft-stability.not-found': 'No stability paragraph found.',
    // sotd/pp
    'sotd.pp.no-pp':
        'Required patent policy paragraph not found. ${expected}. Expected text related to patent policy requirements: <blockquote>${expected}</blockquote>',
    ...
    'sotd.pp.no-pp2017':
        'The WG is operating under the patent policy 2017 but the document mentions a different one',
    'sotd.pp.no-pp2020':
        'The WG is operating under the patent policy 2020 but the document mentions a different one',
    ...
    'sotd.pp.no-jan24':
        'No valid link to 2002 Jan 24 patent policy (eg absent, or not using HTTPS).',
    'sotd.pp.no-pp-transition':
        'No valid link to PP transition procedure (eg absent, or not using HTTPS).',
